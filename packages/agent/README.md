...
This package is a fork of [`@earendil-works/pi-agent-core`](https://github.com/earendil-works/pi/tree/main/packages/agent), copied at upstream commit `845d6ff1f6643aba440341cce877ce1c43ebbc39` (pi `v0.83.0`). It is private to this repository and never published; the `version` field tracks the upstream release the fork is based on.

Why the fork exists, what diverges from upstream, and how to carry upstream fixes across: `docs/pi-fork.md` at the repository root.

Upstream is MIT licensed; `LICENSE` in this directory is the upstream notice and stays with the code. Documentation under `docs/` is upstream's, kept because it describes the code this package owns.
