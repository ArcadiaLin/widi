 ...
 *
 * Ported from pi-coding-agent edit-diff.ts without the TUI preview helpers;
 * this module stays pure text-in/text-out so core tools and tests can share
 * the exact matching and diff semantics.
 */
